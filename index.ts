...
async function main() {
  ...
  const erc20_1 = new ERC20('0xA0b86991c6218b36c1d19D4a2e9Eb0cE3606eB48', null as any, provider, signer);
  const erc20_2 = new ERC20('0xC02aaA39b223FE8D0A0e5C4F27eAD9083C756Cc2', null as any, provider, signer);
  return;
